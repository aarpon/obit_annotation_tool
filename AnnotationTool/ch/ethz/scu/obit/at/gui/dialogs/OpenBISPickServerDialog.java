...
public class OpenBISPickServerDialog extends JDialog {
     ...
     */
    public OpenBISPickServerDialog(ArrayList<AppSettings> configurations,
            AppSettings current,
        ...
        configurationsList.setSelectedItem(current.getConfigurationName());
        configurationsList.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (e.getActionCommand().equals("comboBoxChanged")) {
                    ...
                    String selectedConfigurationName = (String) configurationsList
                            .getSelectedItem();

                    for (AppSettings settings : configurations) {
                        if (settings.getConfigurationName()
                                .equals(selectedConfigurationName)) {
                            selectedConfiguration = settings;
                            return;
                        }
                    }

                    // If not found (this should not happen!), fall back to the
                    // first
        ...
        // Add a checkbox
        configurationSetDefault = new JCheckBox(
                "Set selected as default server");
        constraints.gridx = 0;
        constraints.gridy = 2;
        constraints.gridwidth = 2;
        ...
        selectButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (configurationSetDefault.isSelected()) {
                    globalSettigsManager.setFavoriteConfiguration(
                            selectedConfiguration.getConfigurationName());
                }
                setVisible(false);
                dispose();
            }
