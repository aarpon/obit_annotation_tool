...
public final class FlowEditor extends AbstractEditor {
    ...
    protected List<FlowMetadataMapper> metadataMappersList =
            new ArrayList<FlowMetadataMapper>();
     ...
     */
    public FlowEditor(AbstractViewer dataViewer,
    ...
    protected boolean initMetadata() throws Exception {
        ...
        for (ExperimentNode node : experiments) {
            metadataMappersList.add(
                    new FlowMetadataMapper(node, defaultProjectNode));
        }
    ...
    protected void createUIElements(ObserverActionParameters params) throws Exception {
        ...
        FlowMetadataMapper metadata = metadataMappersList.get(
