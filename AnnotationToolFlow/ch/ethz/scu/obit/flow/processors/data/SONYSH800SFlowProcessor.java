...
public class SONYSH800SFlowProcessor extends AbstractFlowProcessor {
    ...
    protected String getTubeOrWellName(FCSReader processor) {
        ...
        String name = fcsFileName.substring(0,
    ...
    protected Map<String, String> getExperimentAttributes(FCSReader processor) {
        ...
        if (owner.equals("")) {
            owner = processor.getStandardKeyword("$OP");
            if (owner.equals("")) {
                owner = processor.getStandardKeyword("$INST");
                if (owner.equals("")) {
                    owner = "Unknown";
                }
            }
     ...
     * recognized hardware string for one of the SONY Cell Sorters.
     *
